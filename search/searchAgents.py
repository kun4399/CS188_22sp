...
class SearchAgent(Agent):
    ...
    def __init__(
        ...
        self.searchType = globals()[prob]  # globals()返回全局变量的字典，self.searchType是对应的类
...
class PositionSearchProblem(search.SearchProblem):
    ...
    def __init__(
        ...
        startState: tuple (x,y) representing start state
        """
        ...
        self._visited, self._visitedlist, self._expanded = {}, [], 0  # DO NOT CHANGE 这些应该是用来显示算法访问过的节点的，是用来辅助可视化的
    ...
    def getSuccessors(self, state: Tuple[int, int]) -> List[Tuple[Tuple[int, int], str, int]]:
        """
...
class CornersProblem(search.SearchProblem):
    ...
    def getSuccessors(self, state: Any):  # state: (0, 0, 0, 0, (x, y))
        """
        Returns successor states, the actions they require, and a cost of 1.
...
def mazeDistance(point1: Tuple[int, int],
                 ...
                 gameState: pacman.GameState) -> int:
    """
